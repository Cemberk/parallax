...
int main(int argc, char** argv) {
    ...
    printf("  Run A: GDDBG_TRACE=trace_a.gddbg ./loop_divergence 10\n");
    printf("  Run B: GDDBG_TRACE=trace_b.gddbg ./loop_divergence 11\n");
    ...
    // Pre-launch
    gddbg_pre_launch("loop_kernel", gridDim, blockDim);
    ...
    if (iterations == 10) {
        ...
        printf("Next: Compare traces with: gddbg diff trace_a.gddbg trace_b.gddbg\n");
    } else {
